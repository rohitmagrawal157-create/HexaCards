 ...
 * Landing → this grid (Instagram / YouTube / Google) → product detail
 */
  ...
  return (
    <>
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-5 py-8 sm:flex-row sm:items-start sm:justify-between sm:px-8 sm:py-10">
          <div className="min-w-0 max-w-2xl">
            ...
            <p className="mt-2 text-sm text-[#5c5346] sm:text-base">
              Choose Instagram, YouTube, or Google Reviews — then open the
      ...
      <ProductsCatalog
        ...
        description="Each card opens your profile or review page in one tap or scan. Select a card to see full details, pricing, and order options."
        compact
      />
      <HowItWorks />
      <FAQ />
